...
export function AnnouncementBanner() {
  ...
  return (
    <div 
      ...
      className="fixed top-20 left-1/2 -translate-x-1/2 z-50 cursor-pointer text-foreground text-lg sm:text-xl font-semibold hover:opacity-70 transition-opacity"
